...
from controller.cashbackController import CashbackController
from controller.consultaController import ConsultaController
from controller.tipoClienteController import TipoClienteController
...
def historico(request: Request):
    ...
    for dado in dados:
        ...
        consulta = {"ip_usuario":dado['ip'],"data_acesso":dado['data_acesso'],"valor_consulta":dado['valor'],"id_tipo_cliente":tipo_cliente['id'], "nome_tipo_cliente" : tipo_cliente['nome'], "id_cashback":cashback["id"], "valor_cashback":cashback["valor"]}
